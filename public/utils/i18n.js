...
const translations = {
  id: {
    ...
    appearance: "Tampilan",
    darkMode: "Mode Gelap",
    darkModeDescription: "Gunakan tema gelap untuk mengurangi kelelahan mata",
    language: "Bahasa",
    languageDescription: "Pilih bahasa antarmuka aplikasi",
    dataManagement: "Manajemen Data",
    exportData: "Ekspor Data",
    exportDataDescription: "Unduh semua data pengeluaran Anda",
    export: "Ekspor",
    exporting: "Mengekspor...",
    importData: "Impor Data",
    importDataDescription: "Pulihkan data dari file backup",
    import: "Impor",
    importing: "Mengimpor...",
    ...
    pushNotificationsDescription: "Terima notifikasi untuk pengingat dan pembaruan",
    about: "Tentang",
    version: "Versi",
    lastUpdate: "Pembaruan Terakhir",
    appDescription: "Aplikasi manajemen pengeluaran pribadi yang membantu Anda melacak dan mengelola keuangan dengan mudah.",
  ...
  en: {
    ...
    darkMode: "Dark Mode",
    darkModeDescription: "Use dark theme to reduce eye strain",
    language: "Language",
    languageDescription: "Choose application interface language",
    dataManagement: "Data Management",
    exportData: "Export Data",
    exportDataDescription: "Download all your expense data",
    export: "Export",
    exporting: "Exporting...",
    ...
    pushNotificationsDescription: "Receive notifications for reminders and updates",
    about: "About",
    version: "Version",
    lastUpdate: "Last Update",
    appDescription: "Personal expense management app that helps you track and manage your finances easily."
  }
};
