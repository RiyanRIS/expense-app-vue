...
const translations = {
  id: {
    ...
    confirmDeleteAccount: "Apakah Anda yakin ingin menghapus akun? Semua data akan dihapus secara permanen.",
  ...
  en: {
    ...
    confirmDeleteAccount: "Are you sure you want to delete your account? All data will be permanently deleted.",
